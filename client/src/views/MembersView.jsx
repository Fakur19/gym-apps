  ...
  const printInvoice = (member) => {
    ...
    const invoiceHTML = `
        <div id="invoice-section" class="p-10 bg-white" style="font-family: 'Inter', sans-serif;">
            <div class="flex justify-between items-start mb-12"><div class="flex items-center"><img src="/g2.png" alt="Gym Logo" class="w-12 h-12 mr-4"/><div><h1 class="text-2xl font-bold text-gray-800">ESA GYM</h1><p class="text-sm text-gray-500">Jalan Kp Cijeungjing No 101</p><p class="text-sm text-gray-500">Padalarang, Jawa Barat</p></div></div><div class="text-right"><h2 class="text-3xl font-bold text-gray-700">INVOICE</h2><p class="text-sm text-gray-500">#${member._id.slice(-6).toUpperCase()}</p></div></div>
